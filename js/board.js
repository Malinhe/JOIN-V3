              ...
              <div class="bo_todo_infos">
                ...
                <br>
                  ...
                  <div class="bo_todo_contacts_prio">
                    <div class="bo_assignedlabel" style="background-color: ${element['assignedColorToBoard']};">${element['assignedLabelToBoard']}</div>
                     ...
                     <div class="mt-25 font61-700">${element['title']}</div>
                        <div>
                         <div class="mt-25 font21-400">${element['description']}</div>
                            ...
                            <div class="mt-25 font21-400"><span class="mr-20 bo_font21-700">Assigned to:</span><span class="bo_assignedlabel" style="background-color: ${element['assignedColorToBoard']};">${element['assignedLabelToBoard']}</span></div>
